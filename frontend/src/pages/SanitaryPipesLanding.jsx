...
import {
  Droplets, Wrench, BrickWall, Zap, Shield, Clock,
  Tag, Package, Filter, Fan
} from "lucide-react";
// Uses plumbing webp as closest match (no dedicated asset for sanitary-pipes)
import servicePlumbing from "@/assets/real_plumbing_sanitary.webp";

const WARNING_SIGNS = [
  { icon: Droplets,  title: "Sewage Smells",       desc: "Foul odors from drains or around the property indicating a sewer blockage, break, or root intrusion." },
  { icon: Wrench,    title: "Gurgling Drains",      desc: "Gurgling sounds from multiple drains at the same time — a sign of a main line blockage developing." },
  { icon: BrickWall, title: "Wet Spots Outside",    desc: "Unexplained wet patches in the garden or on external walls — indicating underground pipe failure." },
  { icon: Zap,       title: "Multiple Blockages",   desc: "More than one drain blocked simultaneously — likely a primary sewer line issue requiring professional inspection." },
  { icon: Shield,    title: "Slow-Flushing Toilets",desc: "Toilets flushing weakly or backing up — a classic early sign of a deteriorating sewer line." },
  { icon: Clock,     title: "Aging Pipe Network",   desc: "Old galvanized or cast-iron pipes prone to corrosion, scaling, and pinhole leaks throughout the system." },
];
...
const PROCESS_STEPS = [
  ...
  { num: "05", title: "Step 5: Site Cleanup",        desc: "All excavation areas reinstated, tiles replaced where possible, and site cleaned before we leave." },
];

const REVIEWS = [
  { name: "Khalid Al Muhairi",   area: "Deira",          review: "Had a major sewer line problem under our villa. Afnan found it with camera inspection and fixed it without breaking half the garden. Professional team." },
  { name: "Emma Johnson",        area: "JVC",             review: "Old galvanized pipes replaced throughout the apartment. No mess, minimal disruption and the water pressure is incredible now. Great value for money." },
  { name: "Anand Krishnamurthy", area: "Business Bay",   review: "Recurring drain blockage finally resolved permanently with hydro-jetting. They also identified a crack in the main line and fixed it. Excellent work." },
];
...
const FAQS = [
  ...
  { q: "How long does pipe replacement take?",           a: "A single apartment pipe replacement typically takes 1–2 days. Larger projects with underground work are quoted individually after the site assessment." },
];
...
const SanitaryPipesLanding = () => (
  <ServiceLandingTemplate
    ...
    warningSubtitle="Sewer and pipe issues worsen rapidly. If you notice any of these signs, call our pipe repair specialists immediately."
    beforeAfter={{
      title: "Before vs After Our Pipe Repair Service",
      subtitle: "See how our professional sanitary and drainage services transform Dubai properties.",
      before: ["Sewage smells throughout the property", "Multiple slow or blocked drains", "Recurring pipe leaks and water damage", "Aging, corroded pipe network throughout"],
      after: ["Fresh, odor-free plumbing everywhere", "Free-flowing drainage in all areas", "Zero leaks with new sealed pipe joints", "New durable pipes rated for 25+ years"],
    }}
    ...
    stats={[["1,200+", "Pipe Jobs Completed"], ["4.7★", "Customer Rating"], ["<1 Hr", "Emergency Response"], ["25+ Yrs", "Pipe Durability"]]}
    reviews={REVIEWS}
    faqs={FAQS}
    faqTitle="Frequently Asked Questions About Sanitary & Pipe Repair in Dubai"
    faqSubtitle="Direct answers to common questions about our drainage, sewer line, and pipe installation services."
    serviceSlug="sanitary-pipes"
    serviceName="Sanitary & Pipe Repair"
    ctaHeading="Pipe or Drain Problem? Call Now."
    ctaSubtitle="Specialist drainage technicians dispatched anywhere in Dubai — available 24 hours a day."
    formUnitLabel="Type of Pipe Issue"
    formUnitOptions={[
      { value: "Blockage",       label: "Drain / Sewer Blockage" },
      { value: "Leak",           label: "Pipe Leak or Burst" },
...
export default SanitaryPipesLanding;
