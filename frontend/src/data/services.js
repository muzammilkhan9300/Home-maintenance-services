...
export const services = [
  ...
  },
  {
    ...
    warningSigns: [
      ...
      { icon: "Server", title: "Outdated Intercom", desc: "Old, broken intercom system causing daily inconvenience and security gaps." },
    ...
    beforeAfter: {
      ...
      after: ["Full smart home control via app", "Smart, automated home control", "Complete access control from every entry", "Remote monitoring from anywhere"],
    },
    keyBenefits: [
      { icon: "Shield", title: "Security Experts", desc: "Access control, intercoms, and alarm systems installed by certified security engineers." },
    ...
    processSteps: [
      ...
      { step: "02", title: "System Design", desc: "A custom layout plan is drawn showing device positions, sensor placements, and cabling routes." },
    ...
    faqs: [
      ...
      { q: "How long does a smart home installation take?", a: "A standard smart lighting setup for a 2-bedroom apartment takes approximately 4–6 hours. Larger systems are quoted by site visit." },
    ],
